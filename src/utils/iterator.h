...
/* ********* iter_next *********** */
#define ITER_NEXT_FUNC_NAME(SELF_TYPE)       CAT(IteratorType(SELF_TYPE), _next)
#define ITER_NEXT_FUNC_SIGNATURE(SELF_TYPE)  IterItem(SELF_TYPE) ITER_NEXT_FUNC_NAME(SELF_TYPE)(SELF_TYPE* const self)
#define ITER_NEXT_FUNC_IMPL(SELF_TYPE)\
    ITER_NEXT_FUNC_SIGNATURE(SELF_TYPE)

#define iter_next(SELF_TYPE, SELF)           ITER_NEXT_FUNC_NAME(SELF_TYPE)(SELF)
...
#define ITER_IMPL(SELF_TYPE, CURR_IMPL, BEGIN_IMPL, END_IMPL, PREV_IMPL, NEXT_IMPL)\
    ...
    ITER_NEXT_FUNC_IMPL(SELF_TYPE)  NEXT_IMPL\
