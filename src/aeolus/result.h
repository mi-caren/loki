...
#define ERR_FUNC_SIGNATURE(TYPE)      Result(TYPE) ERR_FUNC_NAME(TYPE)(Error code, char* (*const strerror) (Error err))
...
/* ********* PANIC *********** */
#define RES_PANIC_FUNC_NAME(TYPE)           CAT(Result(TYPE), _panic)
#define RES_PANIC_FUNC_SIGNATURE(TYPE)     void RES_PANIC_FUNC_NAME(TYPE)(Result(TYPE) res, char* filename, unsigned int linenumber)
